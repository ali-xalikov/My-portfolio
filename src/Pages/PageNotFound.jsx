...
const LETTERS = [
  ...
  "n",
  "x",
  { className: "seven", value: "f" },
  { className: "eight", value: "o" },
  { className: "nine", value: "u" },
  { className: "ten", value: "n" },
  { className: "eleven", value: "d" },
    'n',
  't',
  "m",
];
      ...
      <div className="max-w-6xl w-full flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 text-white space-y-6 text-base font-light">
          ...
          <Link to='/My-portfolio/home'>
            <button className="px-5 py-2 bg-teal-400 text-white rounded-[10px] shadow-2xs shadow-teal-400 cursor-pointer">
              Home
            </button>
          </Link>
        </div>
