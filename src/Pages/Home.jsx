...
export default function Home({ introTexts, language, mode, texts, photo }) {
    return (
      <div className="max-w-[1280px] mx-auto px-8 flex justify-between items-center flex-wrap-reverse">
        <div className="text-[#f8fafc] max-[1113px]:mt-20 max-w-[600px]">
          <div className="mt-20">
            <h1 className="text-5xl md:text-7xl lg:text-8xl text-[#14b8a6] w-[600px]">
              ...
              >
                <Link to='/My-portfolio/about'>Ali</Link>
        ...
        <img
          className="cursor-pointer min-[900px]:mx-auto max-w-[550px] w-full min-[900px]:rounded-[100%] w-full max-sm:rounded-[100%] mt-20 rounded-[250px] max-h-[600px] h-full opacity-[100%] duration-1000 hover:opacity-50 shadow-2xl shadow-teal-500 hover:shadows hover:bg-teal-500"
          src={photo}
          alt=""
        />
      </div>
